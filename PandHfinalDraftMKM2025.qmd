---
title: "Purpose in Life and Happiness: A Comparison"
author: 
...
if (knitr::is_html_output()) {
  ...
  # For Word/PDF output
  demo_table <- flextable(combined_demographics)
  demo_table <- set_caption(demo_table, caption = paste0("Table 1. Demographic Characteristics (N = ", total_n, ")"))
  demo_table <- bold(demo_table, part = "header")
  demo_table <- align(demo_table, i = NULL, j = 1, align = "left", part = "body")
  demo_table <- align(demo_table, i = NULL, j = 2, align = "left", part = "body")
  demo_table <- align(demo_table, i = NULL, j = 3, align = "right", part = "body")
  demo_table <- autofit(demo_table)
  demo_table
}
```
